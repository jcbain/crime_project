...
props12<-df12[6:64]/df12$Population # first find the proportion for each crime
prop12<-cbind(df12[,c(1:5,ncol(df12)-1,ncol(df12))],props12)

props13<-df13[, 6:68]/(df13$Population) # first find the proportion for each crime
prop13<-cbind(df13[,c(1:5,69:70)],props13)

props14<-df14[, 6:68]/(df14$Population) # first find the proportion for each crime
